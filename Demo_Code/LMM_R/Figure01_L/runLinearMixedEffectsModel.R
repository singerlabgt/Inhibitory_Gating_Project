...
tblFilename = paste0(foldN, "/TableData_resFR_allBins_PVLinePlot.txt")
txtFilename = paste0(foldN, "/stats_lme4_resFR_allBins_PVLinePlot.txt") #create .txt file to save LMM outputs
