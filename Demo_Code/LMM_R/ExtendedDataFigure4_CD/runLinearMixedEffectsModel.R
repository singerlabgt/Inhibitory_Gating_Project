...
tblFilename = paste0(foldN, "/TableData_resFR_allBins_noSWR.txt")
txtFilename = paste0(foldN, "/stats_lme4_resFR_allBins_noSWR.txt") #create .txt file to save LMM outputs
...
pbkrtest.limit = 11895
lmerTest.limit = 11895
tblFilename = paste0(foldN, "/TableData_resFR_allBins_withSWR.txt")
txtFilename = paste0(foldN, "/stats_lme4_resFR_allBins_withSWR.txt") #create .txt file to save LMM outputs
