...
tblFilename = paste0(foldN, "/TableData_resFR_allBins_hit.txt")
txtFilename = paste0(foldN, "/stats_lme4_resFR_allBins_hit.txt") #create .txt file to save LMM outputs
...
print(paste0("Narrow Int", " Familiar AllDaysCombined"))
...
# pbkrtest.limit = 12769
# lmerTest.limit = 12769
tblFilename = paste0(foldN, "/TableData_resFR_allBins_updatecue.txt")
txtFilename = paste0(foldN, "/stats_lme4_resFR_allBins_updatecue.txt") #create .txt file to save LMM outputs
